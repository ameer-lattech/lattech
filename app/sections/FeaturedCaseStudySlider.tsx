          ...
          <div className="max-w-[680px] lg:max-w-[520px] lg:pt-[14px]">
            ...
            >
              <div className={textSwapClass} style={tStyle}>
                <div className="text-[12px] tracking-[0.08em] uppercase text-white/60 mb-[22px]">
                  FEATURED CASE STUDY
                </div>
                ...
                <p className="m-0 text-[12.5px] leading-[1.55] text-white/65 max-w-[420px]">
                  {sFront.desc}
                </p>
        ...
        <div className="mx-auto max-w-[1280px] px-[72px] py-[36px] pb-[44px] max-[1100px]:px-[22px] max-[1100px]:py-[28px] max-[1100px]:pb-[36px]">
          ...
          >
            ...
            <div className="max-w-[820px]">
              <div className="text-[16px] leading-[1.55] text-white/80 mb-[18px]">
                {sFront.review.quote}
              </div>
              <div className="text-[12px] text-white/75 mb-[3px]">
                {sFront.review.name}
              </div>
              <div className="text-[11px] text-white/45">{sFront.review.role}</div>
            </div>
          </div>
        </div>
      </div>
