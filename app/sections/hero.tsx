...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-white font-sans">
      {/* BACKGROUND */}
      ...
      {/* CONTENT */}
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1320px] flex-col px-[18px] sm:px-[28px] md:px-[72px]">
        {/* top block */}
        <div className="pt-[54px] sm:pt-[62px] md:pt-[78px]">
          <div className="mx-auto max-w-[820px] md:mx-0">
            ...
            <p className="mt-[14px] md:mt-[20px] mx-auto md:mx-0 max-w-[350px] sm:max-w-[460px] md:max-w-[760px] text-[15px] sm:text-[16px] md:text-[17px] leading-[1.7] text-[#7B7B7B] text-center md:text-left">
              We are your trusted development partner with just one goal in focus to build products that
              generate a lasting, profitable impact.
            </p>
        ...
        {/* LOGOS (auto sliding, seamless loop, still draggable) */}
                ...
                >
                  <div className="flex items-center gap-[10px] md:gap-[12px] opacity-[0.62] transition hover:opacity-100">
                    <img
                      ...
                      loading="lazy"
                    />
                    {/* hide labels on mobile like your screenshot */}
      ...
      {/* global tweaks for smooth linear autoplay */}
      <style jsx global>{`
