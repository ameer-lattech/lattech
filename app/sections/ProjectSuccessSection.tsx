  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto max-w-[1200px] px-6 py-[80px]">
        <div className="grid grid-cols-12 items-center gap-x-[60px]">
          {/* LEFT: layered UI cards (placeholders like screenshot) */}
          <div className="relative col-span-12 lg:col-span-6">
            <div className="relative mx-auto h-[420px] w-full max-w-[520px]">
              {/* far left big faded panel */}
              <div className="absolute left-0 top-[38px] h-[330px] w-[320px] rounded-[14px] bg-white/90 shadow-[0_18px_55px_rgba(0,0,0,0.10)] ring-1 ring-black/5">
                <div className="px-5 pt-5 opacity-35">
                  <div className="text-[10px] font-medium text-[#7a7a7a]">Add team members</div>
                  ...
                  <div className="mt-5 text-[10px] font-medium text-[#7a7a7a]">Add guests</div>
                  <div className="mt-2 h-[28px] w-[210px] rounded-md border border-[#E6E8EB] bg-white" />

                  <div className="mt-5 text-[10px] font-medium text-[#7a7a7a]">Notify people on</div>
                  ...
                  <div className="mt-5 text-[10px] font-medium text-[#7a7a7a]">Set reminder</div>
                  <div className="mt-2 h-[28px] w-[210px] rounded-md border border-[#E6E8EB] bg-white" />
              ...
              <div className="absolute right-[38px] top-0 h-[360px] w-[190px] rounded-[14px] bg-white/90 shadow-[0_18px_55px_rgba(0,0,0,0.10)] ring-1 ring-black/5">
                <div className="p-4 opacity-35">
                  ...
                  <div className="mt-5 h-[150px] rounded-[10px] bg-[#F3F6FB]" />

                  <div className="mt-5 h-[90px] rounded-[10px] bg-[#F7F9FC]" />
                </div>
              </div>

              {/* MAIN centered card */}
              <div className="absolute left-[110px] top-[110px] h-[240px] w-[300px] rounded-[14px] bg-white shadow-[0_25px_70px_rgba(0,0,0,0.14)] ring-1 ring-black/5">
                <div className="p-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="text-[12px] font-semibold text-[#2b2b2b]">Samuel Spencer</div>
                      <div className="text-[10px] text-[#8f8f8f]">sasp@egament.com</div>
                      <div className="mt-1 text-[10px] text-[#9c9c9c]">Creative Director</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid grid-cols-2 overflow-hidden rounded-[10px] border border-[#EEF0F3]">
                    <div className="px-4 py-3">
                      ...
                      <div className="mt-1 text-[16px] font-semibold text-[#2F5BFF]">03</div>
                    </div>
                    <div className="border-l border-[#EEF0F3] px-4 py-3">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span className="text-[16px] font-semibold text-[#2b2b2b]">02</span>
                      </div>
                    </div>
                  </div>

                  <div className="mt-4 text-[10px] font-medium text-[#8a8a8a]">Overall activity</div>
              ...
              {/* soft background fade like screenshot */}
          ...
          <div className="col-span-12 mt-10 lg:col-span-6 lg:mt-0">
            ...
            <h2 className="mt-5 text-[44px] font-semibold leading-[1.12] tracking-[-0.03em] text-[#5a5a5a]">
              We Achieve Project
              <br />
