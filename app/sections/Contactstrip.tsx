      ...
      <div className="relative mx-auto w-full max-w-[1280px] px-6 md:px-10">
        ...
        <div className="grid grid-cols-12 items-start pt-10 pb-12 md:min-h-[290px] md:pt-[44px] md:pb-0">
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="text-[14px] md:text-[24px] font-medium text-[#525252]">
              Contact Info
            </div>

            <h2 className="mt-4 md:mt-6 max-w-[520px] text-[34px] sm:text-[40px] md:text-[60px] font-medium leading-[1.08] tracking-[-0.02em] text-[#595A5A]">
              We are always happy
              <br />
              to assist you
            </h2>
          ...
          <div className="col-span-12 mt-10 grid grid-cols-1 gap-y-10 md:col-span-6 md:mt-0 md:grid-cols-2 md:gap-x-16 md:pl-6 md:pt-[22px]">
            {/* Email */}
            <div>
              <div className="text-[18px] md:text-[24px] font-semibold text-[#595A5A]">
                Email Address
              </div>
              <div className="mt-2 h-[2px] w-[22px] bg-[#CFCFCF]" />

              <div className="mt-6 md:mt-8 text-[15px] md:text-[24px] font-semibold text-[#595A5A]">
                help@info.com
              </div>

              <div className="mt-5 md:mt-6 text-[16px] text-[#525252]">
                Assistance hours:
              </div>
              <div className="mt-1 text-[16px] text-[#525252]">
